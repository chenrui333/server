...
bool Item::eq(const Item *item, Eq_config config) const
{
  /*
...
bool Item_field::eq(const Item *item, Eq_config config) const
{
...
bool Item_basic_value::eq(const Item *item, Eq_config config) const
{
...
bool Item_direct_view_ref::eq(const Item *item, Eq_config config) const
{
...
bool Item_default_value::eq(const Item *item, Eq_config config) const
{
...
bool Item_insert_value::eq(const Item *item, Eq_config config) const
{
...
bool Item_trigger_field::eq(const Item *item, Eq_config config) const
{

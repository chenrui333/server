...
bool Item_func_date_format::eq(const Item *item, Eq_config config) const
{
...
bool Item_date_add_interval::eq(const Item *item, Eq_config config) const
{
...
bool Item_extract::eq(const Item *item, Eq_config config) const
{
  if (this == item)
    return 1;
  if (item->type() != FUNC_ITEM ||
...
bool Item_char_typecast::eq(const Item *item, Eq_config config) const
{
  if (this == item)
    return 1;
  if (item->type() != FUNC_ITEM ||
